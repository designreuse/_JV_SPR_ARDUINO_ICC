...
import com.company.icc.service.impl.MotionServiceImpl;
...
public class MotionController {
    ...
    MotionService motionService = new MotionServiceImpl();
...
//        Dht d = gson.fromJson(json, Dht.class);
        ...
        Motion motion = motionService.getData();
        motion.setMsg("success");
        motion.setStatus("200");
        return motion;
